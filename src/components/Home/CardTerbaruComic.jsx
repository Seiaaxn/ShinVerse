        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 md:gap-6">
                {comics.map((comic, index) => (
                    ...
                    >
                        {/* WRAPPER GAMBAR AGAR TIDAK GEPENG */}
                        <div className="relative w-full aspect-[2/3] overflow-hidden bg-gray-200 dark:bg-gray-800">
                            ...
                            {/* Badge Chapter */}
                            <div className="absolute top-2 right-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-2 py-1 rounded-md text-[10px] md:text-xs font-bold shadow-lg z-10 flex items-center gap-1">
                        ...
                        <div className="p-3 md:p-4">
                            ...
                            <button
                                ...
                                className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-2 rounded-lg hover:from-blue-500 hover:to-cyan-500 transition-all duration-300 text-xs md:text-sm font-semibold shadow-lg hover:shadow-blue-500/50 flex items-center justify-center gap-2"
                            >
