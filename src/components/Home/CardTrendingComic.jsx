          ...
          >
            ...
            {index < 3 && (
              <div className="absolute top-0 left-0 z-20">
                <div className="bg-gradient-to-r from-yellow-500 to-orange-600 text-white px-3 py-1 rounded-br-xl text-xs font-black shadow-lg">
                  #{index + 1}
                </div>
              </div>
            )}
            ...
            <div className="relative w-full aspect-[2/3] overflow-hidden bg-gray-200 dark:bg-gray-800">
              ...
              <div className="absolute top-2 right-2 bg-black/60 backdrop-blur-md text-white px-2 py-1 rounded-md text-[10px] font-bold flex items-center gap-1 border border-white/10">
            ...
            <div className="p-3 md:p-4">
              <h3 className="font-bold text-xs md:text-sm lg:text-base line-clamp-2 mb-3 text-gray-900 dark:text-gray-100 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors h-[2.5rem] md:h-[3rem] overflow-hidden">
                {comic.title}
              </h3>
              
              <button
                onClick={() => handleComicDetail(comic)}
                className="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white py-2 rounded-lg hover:from-orange-500 hover:to-red-500 transition-all duration-300 text-xs md:text-sm font-bold shadow-lg flex items-center justify-center gap-2"
              >
